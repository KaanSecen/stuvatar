...
return [
    ...
    */
    ...
    'default' => env('LARAVATAR_DRIVER', 'dicebear'),
    ...
    */
    ...
    'drivers' => [
        ...
        'dicebear' => [
            ...
            'options' => [
                'size' => 512,
                'style' => 'pixel-art', /** @see \AmplifiedHQ\Laravatar\Drivers\DiceBear::$styles for supported styles */
                'format' => 'png', /** @see \AmplifiedHQ\Laravatar\Drivers\DiceBear::$formats for supported formats */
            ],
        ],
        'ui-avatars' => [
